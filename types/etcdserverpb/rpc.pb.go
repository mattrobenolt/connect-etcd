...
const file_etcdserverpb_rpc_proto_rawDesc = "" +
	"\n" +
	"\x16etcdserverpb/rpc.proto\x12\fetcdserverpb\x1a\x11authpb/auth.proto\x1a\x0fmvccpb/kv.proto\"\x85\x01\n" +
	...
	"\fignore_lease\x18\x06 \x01(\bR\vignoreLease\"n\n" +
	"\vPutResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\x12)\n" +
	"\aprev_kv\x18\x02 \x01(\v2\x10.mvccpb.KeyValueR\x06prevKv\"\\\n" +
	"\x12DeleteRangeRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12\x1b\n" +
	"\trange_end\x18\x02 \x01(\fR\brangeEnd\x12\x17\n" +
	"\aprev_kv\x18\x03 \x01(\bR\x06prevKv\"\x92\x01\n" +
	...
	"\bprev_kvs\x18\x03 \x03(\v2\x10.mvccpb.KeyValueR\aprevKvs\"\xa9\x02\n" +
	"\tRequestOp\x12A\n" +
	...
	"\brevision\x18\x01 \x01(\x03R\brevision\"\x85\x01\n" +
	...
	"\x10compact_revision\x18\x03 \x01(\x03R\x0fcompactRevision\"X\n" +
	"\fHashResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\x12\x12\n" +
	...
	"\x04blob\x18\x03 \x01(\fR\x04blob\"\x86\x02\n" +
	"\fWatchRequest\x12I\n" +
	...
	"\x14WatchProgressRequest\"\xa9\x02\n" +
	"\rWatchResponse\x124\n" +
	...
	"\x06events\x18\v \x03(\v2\r.mvccpb.EventR\x06events\"5\n" +
	...
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"\xcf\x01\n" +
	"\fAlarmRequest\x12>\n" +
	...
	"\x05alarm\x18\x02 \x01(\x0e2\x17.etcdserverpb.AlarmTypeR\x05alarm\"x\n" +
	"\rAlarmResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\x121\n" +
	...
	"\tisLearner\x18\n" +
	" \x01(\bR\tisLearner\"\x13\n" +
	"\x11AuthEnableRequest\"\x14\n" +
	"\x12AuthDisableRequest\"\x13\n" +
	"\x11AuthStatusRequest\"E\n" +
	...
	"\aoptions\x18\x03 \x01(\v2\x16.authpb.UserAddOptionsR\aoptions\x12&\n" +
	"\x0ehashedPassword\x18\x04 \x01(\tR\x0ehashedPassword\"(\n" +
	...
	"\x0ehashedPassword\x18\x03 \x01(\tR\x0ehashedPassword\"B\n" +
	...
	"\x04perm\x18\x02 \x01(\v2\x12.authpb.PermissionR\x04perm\"d\n" +
	"\x1fAuthRoleRevokePermissionRequest\x12\x12\n" +
	"\x04role\x18\x01 \x01(\tR\x04role\x12\x10\n" +
	"\x03key\x18\x02 \x01(\fR\x03key\x12\x1b\n" +
	"\trange_end\x18\x03 \x01(\fR\brangeEnd\"J\n" +
	"\x12AuthEnableResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"K\n" +
	"\x13AuthDisableResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"\x88\x01\n" +
	"\x12AuthStatusResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\x12\"\n" +
	"\fauthRevision\x18\x03 \x01(\x04R\fauthRevision\"b\n" +
	...
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"a\n" +
	"\x13AuthUserGetResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\x12\x14\n" +
	"\x05roles\x18\x02 \x03(\tR\x05roles\"N\n" +
	"\x16AuthUserDeleteResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"V\n" +
	"\x1eAuthUserChangePasswordResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"Q\n" +
	"\x19AuthUserGrantRoleResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"R\n" +
	"\x1aAuthUserRevokeRoleResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"K\n" +
	"\x13AuthRoleAddResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"s\n" +
	"\x13AuthRoleGetResponse\x124\n" +
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\x12&\n" +
	"\x04perm\x18\x02 \x03(\v2\x12.authpb.PermissionR\x04perm\"b\n" +
	...
	"\x06header\x18\x01 \x01(\v2\x1c.etcdserverpb.ResponseHeaderR\x06header\"W\n" +
	...
	"\tDowngrade\x12\x1e.etcdserverpb.DowngradeRequest\x1a\x1f.etcdserverpb.DowngradeResponse\"\x002\xb0\f\n" +
	"\x04Auth\x12Q\n" +
	"\n" +
	"AuthEnable\x12\x1f.etcdserverpb.AuthEnableRequest\x1a .etcdserverpb.AuthEnableResponse\"\x00\x12T\n" +
	"\vAuthDisable\x12 .etcdserverpb.AuthDisableRequest\x1a!.etcdserverpb.AuthDisableResponse\"\x00\x12Q\n" +
	"\n" +
	"AuthStatus\x12\x1f.etcdserverpb.AuthStatusRequest\x1a .etcdserverpb.AuthStatusResponse\"\x00\x12W\n" +
	"\fAuthenticate\x12!.etcdserverpb.AuthenticateRequest\x1a\".etcdserverpb.AuthenticateResponse\"\x00\x12P\n" +
	"\aUserAdd\x12 .etcdserverpb.AuthUserAddRequest\x1a!.etcdserverpb.AuthUserAddResponse\"\x00\x12P\n" +
	"\aUserGet\x12 .etcdserverpb.AuthUserGetRequest\x1a!.etcdserverpb.AuthUserGetResponse\"\x00\x12S\n" +
	"\bUserList\x12!.etcdserverpb.AuthUserListRequest\x1a\".etcdserverpb.AuthUserListResponse\"\x00\x12Y\n" +
	"\n" +
	...
	"\aRoleAdd\x12 .etcdserverpb.AuthRoleAddRequest\x1a!.etcdserverpb.AuthRoleAddResponse\"\x00\x12P\n" +
	"\aRoleGet\x12 .etcdserverpb.AuthRoleGetRequest\x1a!.etcdserverpb.AuthRoleGetResponse\"\x00\x12S\n" +
	"\bRoleList\x12!.etcdserverpb.AuthRoleListRequest\x1a\".etcdserverpb.AuthRoleListResponse\"\x00\x12Y\n" +
	"\n" +
	...
	"\x14RoleRevokePermission\x12-.etcdserverpb.AuthRoleRevokePermissionRequest\x1a..etcdserverpb.AuthRoleRevokePermissionResponse\"\x00B\x9d\x01\n" +
	"\x10com.etcdserverpbB\bRpcProtoP\x01Z/go.withmatt.com/connect-etcd/types/etcdserverpb\xa2\x02\x03EXX\xaa\x02\fEtcdserverpb\xca\x02\fEtcdserverpb\xe2\x02\x18Etcdserverpb\\GPBMetadata\xea\x02\fEtcdserverpbb\x06proto3"

var (
	file_etcdserverpb_rpc_proto_rawDescOnce sync.Once
	file_etcdserverpb_rpc_proto_rawDescData []byte
)

func file_etcdserverpb_rpc_proto_rawDescGZIP() []byte {
	file_etcdserverpb_rpc_proto_rawDescOnce.Do(func() {
		file_etcdserverpb_rpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_etcdserverpb_rpc_proto_rawDesc), len(file_etcdserverpb_rpc_proto_rawDesc)))
	})
...
var file_etcdserverpb_rpc_proto_goTypes = []any{
...
func file_etcdserverpb_rpc_proto_init() {
	...
	file_etcdserverpb_rpc_proto_msgTypes[20].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_etcdserverpb_rpc_proto_rawDesc), len(file_etcdserverpb_rpc_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   95,
			NumExtensions: 0,
			NumServices:   6,
