...
const file_authpb_auth_proto_rawDesc = "" +
	"\n" +
	"\x11authpb/auth.proto\x12\x06authpb\"1\n" +
	...
	"\rkeyPermission\x18\x02 \x03(\v2\x12.authpb.PermissionR\rkeyPermissionBz\n" +
	"\n" +
	"com.authpbB\tAuthProtoP\x01Z)go.withmatt.com/connect-etcd/types/authpb\xa2\x02\x03AXX\xaa\x02\x06Authpb\xca\x02\x06Authpb\xe2\x02\x12Authpb\\GPBMetadata\xea\x02\x06Authpbb\x06proto3"
